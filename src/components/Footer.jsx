  ...
  return (
    <footer className="footer-wrap">
      <div className="footer-container">
        ...
        {/* Hun eh box Home page de CTA de bilkul thalle fit aauga */}
      ...
      <style>{`
        /* Gap set karan layi margin-top zero kita te padding control kiti */
        ...
        .logo-box { width: 32px; height: 32px; background: var(--t1); color: var(--bg); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 12px; }
        ...
        @media (max-width: 900px) {
          .footer-wrap { padding: 40px 0 30px; } /* Mobile te top padding ghat kitti */
